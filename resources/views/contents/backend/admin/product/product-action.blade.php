 ...
 --}}
	<div class="btn-group">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="product/show/{{ $id }}"><i class="text-success bx bx-search"></i>  Ver Detalles del Producto</a></li>
          <li><a class="dropdown-item" href="product/show/{{ $id }}"><i class="text-danger bx bx-loader"></i>  Sincronizar con la Tienda Virtual</a></li>
        </ul>
      </div>
</div>
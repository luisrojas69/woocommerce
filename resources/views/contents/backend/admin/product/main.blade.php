                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                      <div class="content-left">
                       ...
                       <small>Productos en Tienda Fisica<a href="javascript:void(0)"><i class='bx bx-radio-circle-marked'></i></a></small>
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                      <div class="content-left">
                       ...
                       <small>Productos en Tienda Virtual<a href="{{ route('web.product.index') }}"><i class='bx bx-right-arrow-alt'></i></a></small>
                      </div>
...
$(document).ready( function () {
   ...
   $('#product-datatable').DataTable({
        ...
        ajax: "{{ url('local/products') }}",
        columns: [
            { data: 'sku', name: 'sku' },
            { data: null,
              render: function (data, type, row, meta) {
                {data = "<div class='d-flex align-items-center'><img src='http://localhost:8000/assets/img/avatars/perfume.png' alt='Oneplus' height='32' width='32' class='me-3'><div class='d-flex flex-column'><h6 class='mb-0'>"+row.name+"</h6><small class='text-body'> SKU: "+row.sku+"</small></div></div>";}
               return data
                } 
            },
            { data: 'qty',

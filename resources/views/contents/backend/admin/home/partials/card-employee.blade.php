    ...
    <div class="card card-border-shadow-primary h-100">
      <div class="card-body">
        <div class="d-flex align-items-center mb-2 pb-1">
          ...
          <h4 class="ms-1 mb-0">{{-- $employees --}}500</h4>
        </div>
        <p class="mb-1">Empleados</p>
        <p class="mb-0">
          <span class="fw-medium me-1">+18.2%</span>
          <small class="text-muted">la ultima semana</small>
          <a href="{{ route('admin.home') }}" class="btn btn-sm btn-outline-primary">Ver Empleados</a>
        </p>
      </div>
    </div>
  </div>
